...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <motion.h3 initial={{y: -20, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 0.3}} className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi | I'm Abhishek Kumar <Image className="w-6" src={assets.hand_icon} alt=""/></motion.h3>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <motion.a initial={{y: 30, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay:1.2}} className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black' href="/abhishek-resume.pdf" download>my resume <Image className='w-4' src={assets.download_icon} alt=''/></motion.a>
        </div>
    </div>
  )
}
